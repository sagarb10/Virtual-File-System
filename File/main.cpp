...
PINODE head=NULL;
 ...
 void man(char *name)
 {
	 ...
	 {
		 printf("Description : Used to read data from reular file \n");
		 printf("Usage : read File_name No_of_Bytes_to_read\n");
	 }
	 else if(_stricmp(name,"write")==0)
	 {
		 printf("Description:Used towrite into regular file\n");
		 printf("Usage : write File_name\nAfter theis enter the data that we want to write\n");
	 }
	 else if(_stricmp(name,"ls")==0)
	 {
		 printf("Description:Used to list all imformation of files\n");
		 printf("Usage : ls\n");
	 }
	 ...
	 else if(_stricmp(name,"lseek")==0)
	 {
		 ...
		 printf("Usage : lseek FileInOffset StartPoint\n");
	 }
 ...
 void DisplayHelp()
 {
	 printf("ls: ToList out all files\n");
	 ...
	 printf("exit : To Terminate file intfile system\n ");
	 printf("stat: To Display information of file using name\n");
	 printf("tstat: To Display information of file using file Descriptor");
...
UFDTArr[i].ptrfiletable->ptrinode->FileActualSize=0;//class inode has no member FileActuralSize
...
return i;
 ...
 int rm_File(char *name)
 {
	 ...
	 fd=GetFDFromName(name);//GetFDFFromName undefine identifier
	 if(fd==-1)   return -1;
	...
	memset(UFDTArr[i].ptrfiletable->ptrinode->FileName,0,sizeof((UFDTArr[i].ptrfiletable->ptrinode->FileName)));
 ...
 int fstat_file(int fd)
 {
	 ...
	 printf("\n-----Staatistical Information about file----------\n");
	 printf("File name:%s\n",temp->FileName);
 ...
 int stat_file(char *name)
 {
	 ...
	 printf("\n------Statistial Information about file------\n");
	 printf("File name:%s\n",temp->FileName);
	 printf("Inode Number %d\n",temp->InodeNumber);
	 printf("File size:%d\n",temp->FileSize);
	 printf("Actual file size :%d\n",temp->FileActualSize);
		...
		fflush(stdin);
		 ...
		 else if(count==3)
		 {
			 ...
			 else if(_stricmp(command[0],"open")==0)
			 {
				 ...
				 if(ret>=0)
					 printf("file is successfully opended with descriptor: %d\n",ret);
				 if(ret==-1)
					 printf("ERROR:Incorrect parameters\n");
				 if(ret==-2)
